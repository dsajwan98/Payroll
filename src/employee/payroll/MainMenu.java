...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jButton6.setBounds(820, 30, 40, 30);
        ...
        jButton7.setBounds(520, 390, 197, 60);

        jButton3.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/employee/payroll/images/Deduction.png"))); // NOI18N
        ...
        jButton3.setBounds(150, 400, 197, 59);

        jButton2.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/employee/payroll/images/Allowance.png"))); // NOI18N
        ...
        jButton2.setBounds(340, 290, 197, 59);

        add_employee.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        add_employee.setIcon(new javax.swing.ImageIcon(getClass().getResource("/employee/payroll/images/Add_Employee.png"))); // NOI18N
        ...
        add_employee.setBounds(160, 190, 197, 60);
        ...
        jButton5.setBounds(510, 190, 197, 59);

        label.setText("Logged in as:");
        jPanel2.add(label);
        label.setBounds(10, 574, 80, 20);

        lbl_emp.setText("emp");
        jPanel2.add(lbl_emp);
        lbl_emp.setBounds(90, 574, 170, 20);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/employee/payroll/images/frame.jpg"))); // NOI18N
        jPanel2.add(jLabel2);
        jLabel2.setBounds(0, -20, 900, 640);

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -5, 903, 610));
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        try {
           ...
           float[] columnWidths = new float[] { 3,7,7,7,7,7,7,7,7,7,7,6,8};
           table.setWidths(columnWidths);
          ...
          table.addCell(new PdfPCell(new Paragraph("CREATED_BY",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          ...
          table.addCell(new PdfPCell(new Paragraph("DA",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("HRA",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          ...
          table.addCell(new PdfPCell(new Paragraph("OTHERS",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        try {
           ...
           float[] columnWidths = new float[] { 3,6,7,7,7,7,6,7,7};
           table.setWidths(columnWidths);
          ...
          table.addCell(new PdfPCell(new Paragraph("SURNAME",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("SALARY",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("PF",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("IT",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("OTHERS",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("TOTAL DEDUCTIONS",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
